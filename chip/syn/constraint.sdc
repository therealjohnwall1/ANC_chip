current_design anchor_top

# 100 ns clock period = 10 MHz. Deliberately relaxed: first learning pass
# should close timing easily; tighten later and watch WNS/TNS move.
